...
#if !defined(SRPOUNDDEFUNES_INCLUDED)
#define SRPOUNDDEFUNES_INCLUDED

#define SKIPCONTINATION true
#define BDFDISP true
#define COPYROWS true
#define CHECKFORTRAILINGCOMMENT true
#define CHECKERRORONLY true
#define PARTIALCLEANUP true
#define READPREVP true



#endif //!defined(SRPOUNDDEFUNES_INCLUDED)
